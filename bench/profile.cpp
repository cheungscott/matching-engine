...
int main(int argc, char** argv) {
    ...
    // cache-miss counter this binary exists to have sampled (D27); doing it after
    ...
    if (mode == "none") {
        ...
        // D27 — `live` is in insertion order, i.e. strictly ascending ids, and
        ...
        //
        // D27 — the price draw used to happen INSIDE the loop, and only in this
    ...
    // D27 — refuse if the pool ran out mid-measurement. The mode would still
