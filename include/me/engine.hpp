...
//
// ===========================================================================
//  Interface only; bodies are stubs until Phase 1.
// ===========================================================================
//
// PHASE 1 SCOPE ONLY. Deliberately excluded until later phases:
...
//
// THE TWO RULES THIS PHASE ENCODES:
//
...
//      condition. This is the single most common matching bug and it is
//      one character wide.
//
// PROVISIONAL API, and knowingly so: trades go into a caller-owned vector.
// Allocating per call would violate the allocation-free goal, but Phase 1 is about
...
public:
    ...
    OrderId apply(const NewOrder& /*cmd*/, std::vector<Trade>& /*out*/) {
        // TODO: the match loop (Blueprint §4.2):
