...
// the pool — Blueprint invariant 7, the classic object-pool bug — is
...
//
// Rule 2 is a constraint on the Order layout, so it was decided before the
// pool was implemented, not after.
#pragma once
