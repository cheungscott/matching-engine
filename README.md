...
argument that the design was safe had been re-read three times and never
checked; running the code checked it.
...
Checking the whole codebase against its own stated design intent
found 25 issues, recorded in D19 through D23; a second check before the v0.1 tag found
nine more, including four regressions caused by the earlier fixes, recorded
in D25 and D26. The
recurring failure is worth naming: **a decision's rationale lives
